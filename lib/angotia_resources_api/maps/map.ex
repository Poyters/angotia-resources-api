defmodule AngotiaResourcesApi.Maps.Map do
  use Ecto.Schema
  ...
  def changeset(map, attrs) do
    map
    |> cast(attrs, [:_id, :min_entry_level, :description, :map_name, :map_pic, :visibility_range])
    |> validate_required([:_id, :min_entry_level, :map_name, :visibility_range])
