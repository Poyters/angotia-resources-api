defmodule AngotiaResourcesApi.RequestedChars.Char do
  use Ecto.Schema
  ...
  def changeset(char, attrs) do
    char
    |> cast(attrs, [:name, :_id, :field_diameter, :move_type, :type, :has_visible_level, :char_pic, :mob_range, :is_mob_aggressive, :author])
    |> validate_required([:name, :_id, :field_diameter, :type, :has_visible_level, :char_pic, :author])
